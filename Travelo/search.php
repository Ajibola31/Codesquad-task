						...
						<div class="home_search_content">
							<form action="#" class="home_search_form" id="home_search_form">
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start">
									...
									<button class="home_search_button"name="submit">search</button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="col">
					<div class="destinations_container item_grid">
                        ...
                        <?php
                            ...
                            $info = "SELECT * FROM search WHERE city='$search_city' AND price <= $search_price";
                            $query_info = mysqli_query($connection,$info);
                            while($info_det = mysqli_fetch_assoc($query_info)){
                                $city_name = $info_det["city"];
                                $city_picture = $info_det["picture"];
                                $city_destination = $info_det["destination"];
                                $city_price = $info_det["price"];
						...
						<div class="destination item">
							...
							<div class="destination_content">
								<div class="destination_title"><a href="#" name="city"><?php echo $city_destination;?></a></div>
								<div class="destination_subtitle"><p> <?php echo $city_name; ?> </p></div>
								<div class="destination_price" name="price">From $<?php echo $city_price;?></div>
